...
var ContactController = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Contact_model_1.default.create(contact)];
                    case 1:
                        newContact = _a.sent();
                        return [2 /*return*/, response.status(201).json(newContact)];
                }
            });
        });
    },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        contacts = _a.sent();
                        return [2 /*return*/, response.json({ contacts: contacts })];
                }
            });
        });
    },
    update: function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var contactId, contactUpdates, contactUpdated;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        contactId = request.params.id;
                        return [4 /*yield*/, Contact_model_1.default.findByIdAndDelete(contactId)];
                    case 1:
                        _a.sent();
